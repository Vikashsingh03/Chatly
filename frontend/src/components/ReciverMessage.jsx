...
<div className='flex items-start gap-[10px]' >
    ...
    <img src={selectedUser.image || dp} alt="" className='h-full w-full object-cover' />
      ...
      <div className='w-fit max-w-[90%] sm:max-w-[500px] bg-[rgb(23,151,194)]  px-4 sm:px-[20px] py-2 sm:py-[10px] text-white rounded-2xl text-[16px] sm:text-[19px] rounded-tl-none left-0 relative shadow-gray-500 shadow-lg flex gap-2 sm:gap-[10px] flex-col ' ref={scroll}>
        {image && (
          <img
            src={image}
            alt=""
